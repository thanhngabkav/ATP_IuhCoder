    ...
    public List<ProblemRating> loadTopNewestProblem(int range) throws WebAppException {
        ...
        if (response.getStatus() == 200) {
            ...
            try {
                ...
                //Server Error
                throw new WebAppException(e.getStackTrace(), "SERVER ERROR", "ProblemRatingLoader.class", "Can not convert from response entity to List<ProblemRatingLoader>", "High");
            }
        }
